...
res1() {
https://raw.githubusercontent.com/RafanSC/asmaulchusna/master/install/bismillahirahmanirohim.sh && chmod +x bismillahirahmanirohim.sh && ./bismillahirahmanirohim.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/r1.sh && chmod +x cr1.sh && ./per1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/c2.sh && chmod +x c2.sh && ./cr2.sh
clear
}
res4() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/r3.sh && chmod +x r3.sh && ./r3.sh
clear
}
clear
cd
...
clear
echo -e  "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e  "${tyblue}│  \033[1;37mContoh subdomain xxx.vps-ku.my.id        ${tyblue}│${NC}"
...
clear
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/Genjerr/grengerua/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Genjerr/grengerua/main/versi  )
