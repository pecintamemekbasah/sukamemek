...
rm -rf /etc/asmaulchusna
mkdir -p /etc/asmaulchusna
mkdir -p /etc/asmaulchusna/theme
...
echo "### $author $hhari $MYIP rafan" >> penak
...
sed -i "/# VIP/a ### ${author2} ${hhari2} ${MYIP2} ON 999 VIP" /root/Telorswich/penak
...
sed -i "/# RESELLER/a ### ${author3} ${hhari3} ${MYIP3} ON 999" /root/Genjerr/penak
...
wget https://raw.githubusercontent.com/Telorswich/penamas/master/penak >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
sed -i "/# RESELLER/a ### ${author} ${hhari} ${MYIP} ${ADMIN} ${TOTALIP}" /root/asmaulchusna/penak
else
...
cat <<EOF>> /etc/asmaulchusna/theme/red
BG : \E[40;1;41m
TEXT : \033[0;31m
EOF
cat <<EOF>> /etc/asmaulchusna/theme/green
BG : \E[40;1;42m
TEXT : \033[0;32m
EOF
cat <<EOF>> /etc/asmaulchusna/theme/yellow
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
cat <<EOF>> /etc/asmaulchusna/theme/blue
BG : \E[40;1;44m
TEXT : \033[0;34m
EOF
cat <<EOF>> /etc/asmaulchusna/theme/magenta
BG : \E[40;1;95m
TEXT : \033[0;95m
EOF
cat <<EOF>> /etc/asmaulchusna/theme/cyan
BG : \E[40;1;46m
TEXT : \033[0;36m
EOF
cat <<EOF>> /etc/asmaulchusna/theme/color.conf
red
EOF
function asmaulchusna2(){
cd
...
"'&reply_markup={"inline_keyboard":[[{"text":"🛂ᴏʀᴅᴇʀ","url":"https://t.me/rafanstr18"},{"text":"🎲GRUP","url":"https://t.me/rafanstr18"}]]}'
